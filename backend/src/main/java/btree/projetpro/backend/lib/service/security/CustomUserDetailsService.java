...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public String changeEmail(ChangeEmailRequest changeEmailDto) {
        try {
            User appUser = (User) loadUserByUsername(changeEmailDto.getCurrentEmail());
    ...
    public String changePwd(ChangePasswordRequest changePasswordDto) {
        try {
            User appUser = (User) loadUserByUsername(changePasswordDto.getEmail());
    ...
    public String pwdForgot(String email) {
        try {
            User appUser = (User) loadUserByUsername(email);
