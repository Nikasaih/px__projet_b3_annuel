...
public class ArticleControllerTests {
    ...
    void test_createOne() {
        ...
        ResponseEntity<?> response = template.postForEntity(CREATE_ONE_ROUTE, articleDto, Object.class);
    ...
    void test_createOne_badBinding() {
        ...
        ResponseEntity<Object> response = template.postForEntity(CREATE_ONE_ROUTE, articleDto, Object.class);
    ...
    void test_updateOne() {
        ...
        ResponseEntity<Object> response = template.postForEntity(UPDATE_ONE_ROUTE, articleDto, Object.class);
